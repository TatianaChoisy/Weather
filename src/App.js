...
// OpenWeatherMap API
const APIkey = "5599d3fb4d1c64f63b465ce2d75bc20e";
            ...
            <div className="max-w-[378px] mx-auto flex flex-col gap-y-6">
              <div className="flex justify-between">
                <div className="flex items-center gap-x-2">
                  ...
                  <div>
                    Visibility{" "}
                    <span className="m1-2">{data.visibility / 1000} km</span>
                  </div>
                </div>
                <div className="flex items-center gap-x-2">
                  {/* icon */}
              ...
              <div className="flex justify-between">
                <div className="flex items-center gap-x-2">
                  ...
                  <div>
                    Humidity <span className="m1-2">{data.main.humidity}%</span>
                  </div>
                </div>
                <div className="flex items-center gap-x-2">
                  {/* icon */}
                  ...
                  <div>
                    Wind <span className="m1-2">{data.wind.speed} m/s</span>
                  </div>
                </div>
              </div>
            </div>
